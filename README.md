...
|------|------|---------------|
| _Your Name_ | _Role_ | _Describe your commits_ |
| _Teammate 2_ | _Role_ | _Describe their commits_ |

> Each team member must have at least one meaningful commit before submission.
...
This project was developed with AI assistance (Cursor). The chat log should be exported and submitted with the project as required by course policy.
...
- [ ] AI chatlog exported and submitted
